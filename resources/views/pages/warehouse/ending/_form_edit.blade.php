       ...
       <div class="form-group">
            ...
            <div  class="col-sm-3 ">
                <div class="input-group date">
                    ...
                    {!! Form::text('ending_date',date('Y-m-d',strtotime($endinginventory->ending_date)), ['class'=>'form-control', 'required'=>true]) !!}
                </div>
            </div>

            <label class="col-sm-2 control-label">Prepared by </label>
            <div class="col-sm-3">
                {!! Form::text('prepared_by',$prepared_by, ['class'=>'form-control', 'readonly']) !!}
            </div>
        </div>
